...
Revision ID: 1953e6a0eb82
Revises: 
Create Date: 2022-04-07 09:08:17.360428
...
def upgrade():
    ...
    op.create_index(op.f('ix_set_gaji_perjadin_client_id'), 'set_gaji_perjadin', ['client_id'], unique=False)
...
def downgrade():
    ...
    op.drop_index(op.f('ix_set_gaji_perjadin_client_id'), table_name='set_gaji_perjadin')
