...
Revision ID: fec506f1dd55
Revises: 
Create Date: 2022-04-25 08:00:51.734967
...
def upgrade():
    ...
    op.create_index(op.f('ix_set_gaji_pangkat_besaran'), 'set_gaji_pangkat', ['besaran'], unique=False)
    ...
    op.create_index(op.f('ix_set_gaji_pangkat_jenis_besaran'), 'set_gaji_pangkat', ['jenis_besaran'], unique=False)
    ...
    op.create_index(op.f('ix_set_gaji_pangkat_status'), 'set_gaji_pangkat', ['status'], unique=False)
...
def downgrade():
    ...
    op.drop_index(op.f('ix_set_gaji_pangkat_status'), table_name='set_gaji_pangkat')
    ...
    op.drop_index(op.f('ix_set_gaji_pangkat_jenis_besaran'), table_name='set_gaji_pangkat')
    ...
    op.drop_index(op.f('ix_set_gaji_pangkat_besaran'), table_name='set_gaji_pangkat')
