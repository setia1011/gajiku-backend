...
class SetGajiPotongan(Base):
    __tablename__ = "set_gaji_potongan"

    id = Column(Integer, primary_key=True, index=True)
    potongan = Column(String(200), nullable=False, index=True)
    ...
    ref_client = relationship("Client", backref="set_gaji_potongan")